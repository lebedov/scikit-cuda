...
def suite():
    ...
    s.addTest(test_linalg('test_cdmd_float32'))
    s.addTest(test_linalg('test_cdmd_float64'))
    s.addTest(test_linalg('test_cdmd_complex64'))
    s.addTest(test_linalg('test_cdmd_complex128'))     
